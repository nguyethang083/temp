...
export default function TestRow({ test }) {
  ...
  const questionCount = test.test_questions?.[0].count ?? "N/A";
    ...
    <TableRow key={test.id} className="hover:bg-gray-50 border-b">
      ...
      <TableCell className="py-4 px-6">
        <Badge
          ...
          className={`${getDifficultyColor(test.difficulty)} px-3 py-1 text-xs`} // Adjusted padding/text size
        >
          {test.difficulty || "Unknown"} {/* Display difficulty */}
        </Badge>
      </TableCell>
